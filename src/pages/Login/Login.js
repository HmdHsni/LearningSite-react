...
export default function Login() {
  ...
  const testHandler=()=>{
console.log("i am test an i am fetchin data for user");
  }
  const initialValue={
    user:"" , 
    password:""
      ...
      <section className="login-register">
        <div className="login">
          ...
          <form action="#" className="login-form">
            ...
            <Link to="/test" className= "login-form__btn login-form__btn-success"
                 
              type="submit"
              onClick={testHandler}>
            <i className="login-form__btn-icon fas fa-sign-out-alt"></i>
              <span className="login-form__btn-text">test</span>
            </Link>
          </form>
